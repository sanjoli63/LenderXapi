...
app = Blueprint('GetLoanPurposee', __name__) 
CORS(app)
...
def get_loan_purpose(credentials):
    return execute_lx_api_call(credentials, None, "/lookup", "type=loan_purpose", "GET","text/x-json")

@app.route('/api/get_loan_purpose', methods=['GET'])
def api_get_loan_purpose():
