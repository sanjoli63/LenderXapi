...
app = Blueprint('GetStates', __name__) 
CORS(app)
...
def get_States(credentials):
    return execute_lx_api_call(credentials, None, "/lookup", "type=state&limit=0&loading=true", "GET","text/x-json")
