...
app = Blueprint('GetInvestors', __name__) 
CORS(app)
...
def get_investers(credentials):
    return execute_lx_api_call(credentials, None, "/manage/investor", "limit=0", "GET","text/x-json")

@app.route('/api/get_investors', methods=['GET'])
